...
const Payment = () => {
  return (
    <div>
      ...
      <div className="bg-[url('../src/assets/bread-crumb-bg.jpeg')] text-white bg-no-repeat flex flex-col gap-5 py-40 justify-center items-center">
      ...
      <div className="bg-[url('../src/assets/payment-bg.jpeg')] text-white">
        <div className="flex items-center gap-6 py-10 w-[70%] mx-auto">
        ...
        <div className="py-20 flex gap-10 flex-col w-[65%] mx-auto">
          <div className=" flex items-center justify-between border bg-[#04091E] hover:bg-[#0E1327] hover:border-t-orange-500 hover:border-b-orange-500 border-white rounded-3xl py-8 px-14">
            ...
            <button className="aai-gradient-outline-btn">Get Started</button>
          </div>
          <div className=" flex items-center justify-between border bg-[#0E1327] hover:bg-[#0E1327] hover:border-t-orange-500 hover:border-b-orange-500 border-white rounded-3xl py-8 px-14">
            <div className="flex flex-col gap-3 w-[26%]">
          ...
          <div className=" flex items-center justify-between border bg-[#04091E] hover:bg-[#0E1327] hover:border-t-orange-500 hover:border-b-orange-500 border-white rounded-3xl py-8 px-14">
            <div className="flex flex-col gap-3 w-[27%]">
